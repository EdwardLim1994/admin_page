                    ...
                    <div class="form-group position-relative">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" autocomplete="off" class="form-control" name="customer_account" id="salesorder-search-customer_id" placeholder="" readonly>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-xl modal-notify modal-info" role="document">
            ...
            <div class="modal-content">
                <div class="p-0 m-0 bg-white sticky-top border-bottom">
                    ...
                    <div class="modal-footer justify-content-end">
                        <button id="editSalesOrderSubmitBtn" class="btn btn-info">Update</button>
                    ...
                    <div class="form-group position-relative">
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" autocomplete="off" class="form-control" name="customer_account" id="salesorder-update-search-customer_id" placeholder="" readonly>
                            </div>
                        </div>
