...
switch ($postType) {
	...
	case ("add"):
		...
		if($countSetAdd == count($postVariable)){
			...
			$stmt->bind_param("ssssssssiiisss", $invoice_id, $_POST['in_account'], $_POST['in_name'], $_POST['invoice_num'], $_POST['invoice_date'], $_POST['invoice_remark'], $_POST['doc_no'], $_POST['due_date'], $_POST['subtotal_ex'], $_POST['discount_header'], $_POST['total_amount'], $creation_date, $creation_time, $creation_user);
			$stmt->execute();
			$stmt->close();
			...
			$stmt->bind_param("sssssssssiiisss", $invoice_id, $mode, $_POST['in_account'], $_POST['in_name'], $_POST['invoice_num'], $_POST['invoice_date'], $_POST['invoice_remark'], $_POST['doc_no'], $_POST['due_date'], $_POST['subtotal_ex'], $_POST['discount_header'], $_POST['total_amount'], $creation_date, $creation_time, $creation_user);
			$stmt->execute();
			$stmt->close();
	...
	case ("update"):
		...
		if($countSetUpdate == count($postVariable)){
			...
			$stmt->bind_param("ssssssssiiissss", $_POST['invoice_id'], $_POST['in_account'], $_POST['in_name'], $_POST['invoice_num'], $_POST['invoice_date'], $_POST['invoice_remark'], $_POST['doc_no'], $_POST['due_date'], $_POST['subtotal_ex'], $_POST['discount_header'], $_POST['total_amount'], $modify_date, $modify_time, $modify_user, $_POST['invoice_id']);
			$stmt->execute();
			$stmt->close();
			...
			$stmt->bind_param("sssssssssiiissssss", $_POST['invoice_id'], $mode, $_POST['in_account'], $_POST['in_name'], $_POST['invoice_num'], $_POST['invoice_date'], $_POST['invoice_remark'], $_POST['doc_no'], $_POST['due_date'], $_POST['subtotal_ex'], $_POST['discount_header'], $_POST['total_amount'], $header_creation_date, $header_creation_time, $header_creation_user, $modify_date, $modify_time, $modify_user);
			$stmt->execute();
			$stmt->close();
	...
	case ("deleteHeader"):
		...
		if (isset($_POST["invoice_id"])) {
			...
			if ($stmt->num_rows == 1) {
				...
				$stmtlog->bind_param("sssssssssiiissssss",$_POST['invoice_id'], $mode, $in_account, $in_name, $invoice_num, $invoice_date, $invoice_remark, $doc_no, $due_date, $subtotal_ex, $discount_header, $total_amount, $creation_date, $creation_time, $creation_user, $modify_date, $modify_time, $modify_user);
				$stmtlog->execute();
				$stmtlog->close();
